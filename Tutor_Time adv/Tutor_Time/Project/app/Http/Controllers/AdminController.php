...
class AdminController extends Controller
{
    ...
    {
            $Tutors= course::where('tutor_id',$tutor_id)->delete();
    ...
    { 
     ...
     [
       ...
       if($validator->fails())
        ...
        $app = new course();
        $app->subject=$req->subject;
        $app->medium=$req->medium;
        $app->division=$req->division;
        $app->save();
    ...
    {    
        ...
        $std->medium=$req->medium;
        $std->division=$req->division; 
        $std->save();
    ...
    function csearch(Request $req)//course serarch
    {
                $Courses= course::where('subject','Like','%'. $req->search_cou.'%')->get();
  ...
  function updateStatus($student_id)//student ban
    ...
    function adloginSubmit(Request $req)//admin login
    {
        $validator = Validator::make($req->all(),
        [
            'username' => 'required',

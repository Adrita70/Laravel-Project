...
Route::post('/csearch',[AdminController::class,'csearch']);
...
Route::get('/editCourse/{tutor_id}',[AdminController::class,'editCourse']);
Route::post('/editCourse/{tutor_id}',[AdminController::class,'editCourse']);
